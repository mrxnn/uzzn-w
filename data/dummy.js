const data = [
  ...
  },
  {
    id: 3,
    title:
      "Download by adding this wonderful touches to furniture in your home",
    description:
      "Following the outside of main will not be initialized by the browser. Do not add application logic here or custom CSS. If you need base components in your pages (like a menu or a toolbar), take a look at the App component instead.",
    imageURL: "/images/7.jpg",
    avatar: "/images/maria.jpg",
    author: "Maria Yusefnova",
    publishedAt: "15 Feb 2021",
  },
];
